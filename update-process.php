...
mysqli_query($conn,"UPDATE signup set id='" . $_POST['id'] 
...
<div class="hero">
   ...
   <form id="register" class="input" border=1 action="delete_confirm.php" method="POST" >
...
<input type="text" name=id   class="input-field"  value="<?php echo $row['id']; ?>">
     <button type="submit" name="update" class="submit-btn"><b>Delete</b></button>
<br>
 <button type="submit" name="submit" class="submit-btn"><a href="update.php"><b>Back</b></a></button>
                
        </form>

        <form id="login" class="input" border=1 action="" method="POST">
