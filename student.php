...
<div class="container">
    <header class="header">
       ...
       <a class="link-title" href="/">Student Registration</a>
...
<h3>STUDENT REGISTRATION FORM</h3>
   ...
   <form  border=1 action="stu.php" method="POST"> 
...
<td>
<select name="b_day" id="Birthday_Day">
...
<select name="b_Year" id="Birthday_Year">
...
<tr>
<td>EMAIL ID</td>
<td><input type="text" name="e_name" maxlength="100" /></td>
</tr>
...
<td>MOBILE NUMBER</td>
<td>
<input type="text" name="m_Number" maxlength="11" />
(10 digit number)
</td>
</tr>
...
<td><input name="address" rows="4" cols="30"></td>
</tr>
...
Singing
<input type="checkbox" name="Hobby_Drawing" value="Singing" />
Dancing
...
<td colspan="2" align="center">
      ...
      <button type="submit" name="submit" class="submit-btn">Submit</button></td></tr></td></tr></table>
